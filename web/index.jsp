...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-inverse">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand page-scroll" href="#page-top"><img src="img/Branding_lenovo-logo.png" height="50px"></a>
        </div>
        ...
        <div class="col-sm-7">
            <div class="header-content">
                <div class="header-content-inner">
                    <h1>New Age is an app landing page that will help you beautifully showcase your new mobile app, anything else!</h1>
...
<section id="contact" class="contact bg-primary">
    <div class="container">
        <h2>We <span class="glyphicon glyphicon-heart" style="color:#ff1024;" aria-hidden="true"></span> new friends!
        </h2>
...
<script>
    ...
    $(document).ready(function () {
        $(".navbar-default .nav > li >").css('color', '#ff1024');
